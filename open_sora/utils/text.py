...
def append_score_to_prompt(prompt, aes=None, flow=None, camera_motion=None):
    new_prompt = prompt
...
def process_prompt(prompt, score_kwargs):
    # append score
    prompt = append_score_to_prompt(prompt, **score_kwargs)

    # clean prompt
    prompt = clean_caption(prompt)
    return clean_caption(prompt)
